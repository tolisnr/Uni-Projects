...
/**
 * ClientProtocol: Handles user-side console I/O for the echo client.
 * Encapsulates reading user input from console and displaying server replies.
 */
public class ClientProtocol {

	// BufferedReader to read user input from standard input (console)
	BufferedReader user = new BufferedReader(new InputStreamReader(System.in));
	
	/**
	 * prepareRequest: Prompts the user to enter a message and returns it.
	 * @return The message typed by the user to send to the server.
	 */
